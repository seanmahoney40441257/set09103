...
from yournal.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from yournal.models import User, Post
...
def update_post(post_id):
    ...
    return render_template('create_post.html', title='Update Journal',
                           form=form, legend='Update Journal')
